...
export default function HowItPulseIllustration() {
    return (
        ...
        >
            <defs>
                {/* Colors: #086eb2ff (Teal-600), #22d3ee (Cyan-400), #0ea5e9 (Sky-500) */}
                <linearGradient id="brainGradient" x1="0%" y1="0%" x2="100%" y2="100%">
                    <stop offset="0%" stopColor="#2959ddff" />
                    <stop offset="50%" stopColor="#2959ddff" />
                    <stop offset="100%" stopColor="#2959ddff" />
                </linearGradient>
                <filter id="glow">
            ...
            <g className="brain-float" transform-origin="300 300">
                ...
                <g className="neural-network">
                    ...
                    <line x1="200" y1="200" x2="400" y2="200" stroke="#2959ddff" strokeWidth="1" opacity="0.3" className="line" />
                    <line x1="170" y1="280" x2="430" y2="280" stroke="#2959ddff" strokeWidth="1" opacity="0.3" className="line" />
                    <line x1="220" y1="360" x2="380" y2="360" stroke="#2959ddff" strokeWidth="1" opacity="0.3" className="line" />

                    {/* Vertical Connections         */}
                    <line x1="300" y1="120" x2="300" y2="400" stroke="#2959ddff" strokeWidth="2" opacity="0.2" className="line" />

                    {/* Diagonal Cross-connections */}
                    <path d="M220,180 Q300,250 380,320" fill="none" stroke="#2959ddff" strokeWidth="1" opacity="0.4" />
                    <path d="M380,180 Q300,250 220,320" fill="none" stroke="#2959ddff" strokeWidth="1" opacity="0.4" />
                    ...
                    <g transform="translate(200, 200)">
                        <circle r="8" fill="#2959ddff" opacity="0.7" className="node" />
                    </g>
                    <g transform="translate(400, 200)">
                        <circle r="8" fill="#2959ddff" opacity="0.7" className="node" />
                    </g>
                    <g transform="translate(180, 300)">
                        <circle r="6" fill="#2959ddff" opacity="0.7" className="node" />
                    </g>
                    <g transform="translate(420, 300)">
                        <circle r="6" fill="#2959ddff" opacity="0.7" className="node" />
                    </g>
                    <g transform="translate(250, 380)">
                        <circle r="5" fill="#2959ddff" opacity="0.7" className="node" />
                    </g>
                ...
                <circle cx="300" cy="250" r="100" fill="none" stroke="#2959ddff" strokeWidth="1" strokeDasharray="10 20" opacity="0.2" className="sp2">
                    <animateTransform
                ...
                <circle cx="300" cy="250" r="120" fill="none" stroke="#2959ddff" strokeWidth="0.5" strokeDasharray="5 15" opacity="0.1" />
            </g>
            ...
            <g transform="translate(150, 480)">
                ...
                <circle cx="40" cy="30" r="10" fill="#2959ddff" />
